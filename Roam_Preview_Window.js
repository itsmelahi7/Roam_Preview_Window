function loadRoamPreviewWindow() {
  ...
  var overlayPreviewWindow = document.querySelector(
    ".bp3-overlay-backdrop.rm-modal-backdrop.rm-modal-backdrop--preview-window"
  );
...
function unloadRoamPreviewWindow() {
  document
    .querySelector("#preview-window-overlay .bp3-overlay-scroll-container")
    .remove();
}

export default {
  onload: loadRoamPreviewWindow,
  onunload: unloadRoamPreviewWindow,
};
